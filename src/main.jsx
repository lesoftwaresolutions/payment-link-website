...
const paymentUrl = 'https://invoice.stripe.com/i/acct_1TaJCZGd8Rj0gNcH/live_YWNjdF8xVGFKQ1pHZDhSajBnTmNILF9VcWZPYk93ZmdMTnlRU1o2VG05SlAwZTJsbTRha2VOLDE3NDU5MzUyMg0200p9OQPFpe?s=db';
        ...
        <div className="relative z-10 mx-auto w-full max-w-4xl text-center">
          ...
          <div className="mx-auto mt-10 max-w-xl rounded-3xl border border-cyan-300/20 bg-white/[0.04] p-6 shadow-2xl shadow-cyan-950/40 backdrop-blur">
            ...
            <a
              ...
              className="mt-6 inline-flex w-full items-center justify-center rounded-full bg-cyan-300 px-6 py-4 text-base font-extrabold uppercase tracking-[0.18em] text-slate-950 shadow-[0_0_28px_rgba(103,232,249,0.35)] transition hover:-translate-y-0.5 hover:bg-white focus:outline-none focus:ring-4 focus:ring-cyan-200/40 sm:w-auto"
            >
              Pay invoice
            </a>
          </div>
